...
def get_kline_order():
    ...
    print(df_macd)
    addplot= [
        mpf.make_addplot((df_macd['MACD']),panel=2,ylabel='MACD',color='g'),
        mpf.make_addplot((df_macd['SIGNAL']),panel=2,ylabel='SIGNAL',color='r')
    ]
    mpf.plot(df,addplot=addplot,type='candle',mav=(5,25,100),volume=True,figratio=(10,4),style='yahoo')
    # print('###############################')
